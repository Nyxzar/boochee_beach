<div class="" >
    <section class="theme-container">
        <div class="bg-dark_brown  rounded-none 3xl:rounded-t-3xl">
            <x-book-now></x-book-now>
        </div>
    </section>
    ...
    <section>
        <div class="theme-container bg-light_green text-darker_brown relative ">
            <div class="absolute -top-20" style="width: 20%; z-index: 1; right: 6%;">
                ...
                <div class="pt-8 pb-6">
                    <div class="space-y-12">
                        ...
                        <div class="w-10/12 m-auto"> 
                            <div class="inline-flex justify-between w-full space-y-2"> 
                                <div class="flex">
                                    <div class="signature text-7xl" style="line-height: 1em;"> visit <span>:</span></div>
                                    <div class="pt-4 pl-6"> 
                                        <div>National Highway Tampi, <br> 6204 Negros Oriental</div>
                                    </div>
                                </div>

                                <div class="flex">
                                    <div class="signature text-7xl" style="line-height: 1em;"> write <span>:</span></div>
                                    <div class="pt-4 pl-6"> 
                                ...
                                <div class="flex">
                                    <div class="signature text-7xl" style="line-height: 1em;"> call <span>:</span></div>
                                    <div class="pt-4 pl-6"> 
                                        <div>091999919199</div>
                                    </div>
                                </div>
                            </div>
                        </div>
